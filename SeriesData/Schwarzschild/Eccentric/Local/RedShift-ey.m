...
Module[{DeltaU},
  DeltaU = SeriesData[y, 0, {-1, (-2) (-1 + e^2)^(-1) (-1 + 2 e^2), ResummedSeriesData[(1 - e^2)^(-2), SeriesData[e, 0, {-5, 0, 16, 0, Rational[-85, 8], 0, Rational[-9, 16], 0, Rational[-17, 128]Log[y], 0, Rational[-7, 256]}, 0, 12, 1]]}, 1, 4, 1];
  <|
